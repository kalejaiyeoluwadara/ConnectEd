...
function View() {
 ...
 const handleReviews = async () => {
  ...
  return (
    <div className="sm:w-screen sm:flex sm:flex-row sm:items-start sm:justify-start ">
      <motion.div
        initial={{ opacity: 0, x: "-100vw" }}
        animate={{ opacity: 1, x: 0 }}
        exit={{ opacity: 0, x: "100vw" }}
        transition={{ duration: 0.5 }}
        className="min-h-screen  relative pb-20 w-[screen] sm:w-[70%]  bg-gray-900  "
      >
        {/* First section */}
        ...
        <div className="px-4 mt-4 ">
          <h3 className="font-bold sm:text-center text-[20px] mb-2 ">
            Reviews
          </h3>
          {/* content */}
          <motion.div
          ...
          {/* Input */}
          <div className="fixed sm:bottom-0 bg-gray-900 bottom-0 left-0 pt-6 sm:pt-4 pb-4 z-40 items-center sm:justify-center sm:items-center justify-between sm:px-12 px-8 w-[100%]  flex gap-2  ">
            <input
              className="outline-none w-[78%] sm:w-[400px] px-3 focus:border-[2px] rounded-[8px]  h-[45px] sm:h-[50px] focus:border-blue-500 bg-transparent border border-gray-600  "
              type="text"
              value={review}
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="h-[50px] w-[50px] flex gap-2 font-bold items-center justify-center bg-blue-500 rounded-[50%]  "
