...
function SideBar() {
  return (
    <div className=" invisible sm:visible z-40 sm:flex flex-col fixed px-6 right-0 top-0 bg-gray-900 pt-4 border-gray-100 border-opacity-[0.1] border-l-[1px] h-screen w-[35%] ">
      <SearchComp />
