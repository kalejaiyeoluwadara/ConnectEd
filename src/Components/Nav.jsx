...
function Nav() {
  ...
  return (
    <footer className="w-screen cursor-pointer flex  items-center px-4 justify-between bg-gray-800 z-50 fixed sm:top-0 sm:left-0 sm:h-screen sm:flex-col sm:py-6 sm:rounded-l-none rounded-r-none sm:w-[100px] bottom-0 h-[75px] rounded-t-[20px] left-0">
      <div
        onClick={() => {
          setPage("home");
        }}
