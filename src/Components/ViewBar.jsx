...
function ViewBar() {
  return (
    <div className=" invisible sm:pt-4 fixed top-0 right-0 border-gray-100 border-l-[1px] border-opacity-[0.1] sm:visible z-40 sm:flex flex-col  px-6   bg-gray-900 h-screen w-[30%] ">
      <SearchComp />
